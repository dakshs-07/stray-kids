export const BangchanFacts = [
    "He is the eldest sibling of three.",
    "He is credited with writing some of the most innocent SKZ songs",
    "He created Stray Kids group, logo and chose the members himeself.",
...
export const LeeknowFacts = [
    ...
    "Lee Know is a brand ambassador for Gucci",
    "A very well known member of paboracha",
    "He is very close friends with Han Jisung and both consider each other their soulmate.",
    "He knows boxing and shooting.",
    "Lee Know used to be a backup dancer for BTS before joining JYP.",
    "He auditioned for JYP in 2015, but did not hear back until 2017.",
    "(not a fun fact at all) He was one of the two members eliminated in the survival show. After the show, he walked through the rain as he 'didn't think he deserved a taxi'",
    "He is an only child."
]

export const ChangbinFacts = [
    "He has an older sister",
    "He is considered the babygirl of the group",
...
export const HanFacts = [
    ...
    "He can rap, sing, compose, dance, produce - which is why people call him the 'ace' of Kpop.",
    "Han loves dinosaurs.",
...
export const SeungminFacts = [
    "Seungmin has an elder sister.",
    "He is knownw for hanging out away from the group, fascinated by other things.",
    "He is know for 'Seungming in the building', and has been seen in background of various JYP videos filmed in the building.",
